...
{
	public class PaymentCommandClient : BaseHttpClientAdapter, IPaymentCommandClient
	{
		private readonly IConfiguration _configuration;

		public PaymentCommandClient(HttpClient httpClient, IConfiguration configuration, ILogger<PaymentCommandClient> logger) : 
            base(httpClient, logger)
		{
			_configuration = configuration;
			_httpClient.BaseAddress = new Uri(_configuration.GetSection("HttpClientSettings:PaymentCommand:BaseAddress").Value);
		}
