...
Execute unit tests
```
    cd "Checkout.Payment.Processor.Lambda/test/Checkout.Payment.Processor.Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Checkout.Payment.Processor.Lambda/src/Checkout.Payment.Processor.Lambda"
